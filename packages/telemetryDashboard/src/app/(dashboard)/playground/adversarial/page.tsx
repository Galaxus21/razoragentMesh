  ...
  return (
    <div className="mx-auto max-w-7xl space-y-4">
      <nav className="flex items-center gap-1 text-[11px] uppercase tracking-wide text-textMuted">
        <Link href="/playground" className="hover:text-textSecondary transition-colors">
          Protocol Playground
        </Link>
          ...
          return (
            ...
            >
              <div className="flex flex-wrap items-center gap-1.5">
                ...
                {scenario.testCaseRefs.map((testCase) => (
                  <span
                    key={testCase}
                    className="rounded-full border border-borderSubtle bg-surfaceContainer px-1.5 py-0.5 text-[10px] font-mono text-textMuted"
                  >
                    {testCase}
                  </span>
                ))}
