...
export const docsSearchIndex: readonly DocSearchEntry[] = [
  ...
  },
  {
    ...
    "snippet": "Ask your agent to list its tools. You should see eight : They are listed in the order they are meant to be called: Tool What it does --- --- establish agent...",
    "searchText": "confirm the connection connect your own agent — mcp quickstart ask your agent to list its tools. you should see eight : they are listed in the order they are meant to be called: tool what it does --- --- establish agent delegation pairs your agent, issues a signed intent mandate search catalog natural-language product discovery get live sku quote live price, tax and discount for a sku reserve inventory lock atomic stock reservation with a fencing token verify shipping sla serviceability and delivery-tier check create cart mandate merchant-signed cart at mesh-derived prices sign execution mandate binds intent and cart into an execution mandate execute settlement runs the 2pc settlement saga pair first. in mesh demo custodial the mesh mints your buyer did inside establish agent delegation , so a buyer agent id to quote with does not exist until you have called it. ---"
  },
  {
