...
class NonceLedger:
    ...
    def verifyTimestampWindow(
        ...
        if timestamp < minAllowed:
            from ..settlement.settlementExceptions import TimestampExpiredException
        ...
        if timestamp > maxAllowed:
            from ..settlement.settlementExceptions import FutureTimestampException
    ...
    async def validateAndRecordNonce(
        ...
        if not resultSet:
            from ..settlement.settlementExceptions import NonceReplayException
